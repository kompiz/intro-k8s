...
```
kubectl create configmap nginx-proxy-conf --from-file=nginx/
```
...
Forward local port 10443 to 8443 of the `secure-monolith` Pod:

```
kubectl port-forward secure-monolith 10443:8443
```
